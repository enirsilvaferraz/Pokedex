...
private val typeCardColors: Map<String, Color> = mapOf(
    ...
    "stellar" to Color(0xFFFFD700),
    "unknown" to Color(0xFFBDBCBC),
)

/** Cores alinhadas a [com.eferraz.pokedex.ui.detail.vos.PokemonDetailVo.Background], sem alocar por item. */
internal fun typeCardBackgroundColor(typeName: String?): Color =
    typeName?.let { typeCardColors[typeName.lowercase()] } ?: Color(0xFF888888)
